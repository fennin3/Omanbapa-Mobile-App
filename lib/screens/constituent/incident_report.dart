...
class IncidentReportCon extends StatefulWidget {
  ...
  @override
  _IncidentReportConState createState() => _IncidentReportConState();
}

class _IncidentReportConState extends State<IncidentReportCon> {
  ...
  void sendIncidentRequest(
    ...
    try {
      final response = http.MultipartRequest('POST',
          Uri.parse(base_url + "constituent-operations/send-incident-report/"));
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (txt.isEmpty || _subject.text.isEmpty) {
            MyUtils.snack(context, "please subject and message can not be empty", 2);
          } else {
