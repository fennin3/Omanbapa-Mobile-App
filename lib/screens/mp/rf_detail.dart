...
class RFDetail extends StatefulWidget {
  final Map data;

  RFDetail({required this.data});

  @override
  _RFDetailState createState() => _RFDetailState();
}

class _RFDetailState extends State<RFDetail>
  ...
  void setUnreadToRead() async {
    ...
    http.Response response = await http.post(Uri.parse(
        base_url + "mp-operations/read-requestform/${widget.data['id']}/"));
